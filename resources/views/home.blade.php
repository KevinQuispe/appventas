      ...
      <nav class="navbar navbar-inverse ">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/home') }}"> <img src="assets/css/imagenes/fondo//logo.png" alt="Here Logo"/> </a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
            <!-- <li class="active"><a href="{{ url('/dashboards')}}"><img src="./assets/css/imagenes/fondo//logo.png" alt=""></a></li> -->
            <li class="active"><a href="{{ url('/home')}}">Home</a></li>
             ...
             <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="{{ url('/product/create')}}">Registrar Proveedores</a></li>
                      <div class="divider">
                  </div>
                  <li><a href="{{ url('/product')}}">Listar Proveedores</a></li>
                      <div class="divider">
                </ul>
             </li>
             ...
             <li class="dropdown">
               ...
               <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a href="{{ url('/product')}}">Listar Ventas</a></li>
                     <div class="divider"></div>
               </ul>
            </li>
            <li class="dropdown">
